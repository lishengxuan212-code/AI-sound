...
pub async fn start_system_subtitle_session(app: AppHandle, registry: State<'_, SessionRegistry>) -> Result<(), String> {
    ...
    diagnostic(
        ...
        json!({
            ...
            "note": "System audio capture boundary initialized; local ASR server must be running."
        }),
    );
